...
int main()
{
    ...
    fmtals::ableton::version _version;
    fmtals::ableton::project _project;

    fmtals::import_project(_istream, _project, _version);
    
    fmtals::ableton::project::user_track _track;
    _project.tracks.emplace_back(_track);
    // dfmt::export_project(_ostream, _project, _version);
    fmtals::export_project(_ostream, _project, fmtals::ableton::version::v_9_7_7);
